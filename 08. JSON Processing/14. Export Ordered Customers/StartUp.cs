...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static string GetOrderedCustomers(CarDealerContext context)
        {
            ...
            IEnumerable<OrderedCustomersOutputDTO> customersOutputDTOs = mapper
                .Map<IEnumerable<OrderedCustomersOutputDTO>>(customers);


            return $"{JsonConvert.SerializeObject(customersOutputDTOs, GetSettings())}";
        }
