...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static string GetLocalSuppliers(CarDealerContext context)
        {
            ...
            Supplier[] localSuppliers = context.Suppliers
                .Where(s => s.IsImporter == false)
                .ToArray();

            IEnumerable<LocalSuppliersOutputDTO> dTOs = mapper
                .Map<IEnumerable<LocalSuppliersOutputDTO>>(localSuppliers);


            return $"{JsonConvert.SerializeObject(dTOs, GetSettings())}";
        }
